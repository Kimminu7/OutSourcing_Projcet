...
public enum ErrorCode {
    ...
    UNAUTHORIZED_OWNER("가게 생성 권한이 없습니다.", HttpStatus.UNAUTHORIZED, "401-001"),
    FORBIDDEN_OWNER_COUNT("가게 개수가 너무 많습니다.", HttpStatus.FORBIDDEN, "403-001"),
    FORBIDDEN_OWNER("가게 사장이 아닙니다.", HttpStatus.FORBIDDEN, "403-002"),
    FORBIDDEN_REVIEW("본인의 주문에만 리뷰 작성 가능합니다.", HttpStatus.FORBIDDEN, "403-003"),
    FORBIDDEN_REVIEW_EDIT("본인의 리뷰만 수정할 수 있습니다.", HttpStatus.FORBIDDEN, "403-004"),
    FORBIDDEN_DELETE_REVIEW("본인의 리뷰만 삭제할 수 있습니다.", HttpStatus.FORBIDDEN, "403-005"),
